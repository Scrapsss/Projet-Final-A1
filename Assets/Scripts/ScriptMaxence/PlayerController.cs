...
/// <summary>
/// On va g�rer tout ce qui touche au mouvement de notre personnage :
/// Vitesse
    ...
    private void RoofMove()
{
    ...
    //D�placement gauche droite de base
    private void Move()
    {
        if (!_MovementLock)
        {
            ...
            if (_isRunning)
            {
                ...
                {
                    _isMoving = true;
                    //Le 1 �quivaut � la direction : Droite
                ...
                {
                    _isMoving = true;
                    //Le -1 �quivaut � la direction : Gauche
                    _rigidBody.linearVelocityX = -1.5f * _speed;
                }
                else
                {
    ...
    //Gestion de l'orientation du personnage en fonction de sa v�locit�
    ...
    //Cooldown du bloquage des contr�les suite au saut mural
    ...
    {
        //On v�rifie si l'objet qu'on touche fait partie des murs du jeu
    ...
    private void ShowEndGameMenu()
{
    ...
    {
        Debug.LogWarning("Le menu de fin n'est pas assigné dans l'inspecteur !");
    }
}
    ...
    //On reset tout les �tats de collisions
